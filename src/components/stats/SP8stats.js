let rawStatsSP8 = [
    //mindfreaks 
    {id:"12", game:"3-4, 1 HR, 4 RBI, 2 BB", points:"1.6", OP:"5", day:"7"},
    ...
    {id:"72", game:"2-4, 2 HR, 3 RBI, 1 BB", points:"1.3", OP:"5", day:"8"},
    {id:"60", game:"2-4, 1 2B, 1 HR, 3 RBI, 1 BB", points:"1.2", OP:"5", day:"9"},
    ...
    {id:"101", game:"2-4, 1 2B, 1 HR, 2 RBI", points:"0.9", OP:"3", day:"7"},
    {id:"102", game:"2-4, 1 2B, 3 RBI", points:"0.8", OP:"3", day:"9"},
    {id:"91", game:"2-4, 2 HR, 4 RBI, 1 BB", points:"1.4", OP:"5", day:"1"},
    {id:"3", game:"3-4, 1 2B, 2 HR, 3 RBI", points:"1.4", OP:"5", day:"3"},
    {id:"56", game:"2-4, 1 HR, 2 RBI, 1 SB", points:"0.9", OP:"3", day:"7"},
    ...
    //Aliens
    {id:"25", game:"4-4, 2 HR, 5 RBI, 1 BB", points:"1.9", OP:"5", day:"6"},
    ...
    {id:"46", game:"2-4, 2 2B, 2 RBI, 1 BB", points:"1", OP:"4", day:"9"},
    ...
    {id:"82", game:"5 IP, 3 H, 0 ER, 0 BB, 3 K", points:"0.7", OP:"7", day:"7"},
    //Doodles 
    {id:"40", game:"3-5, 1 2B, 1 HR, 3 RBI", points:"1.2", OP:"5", day:"4"},
    {id:"4", game:"4-5, 1 HR, 2 RBI", points:"1.2", OP:"5", day:"7"},
    {id:"95", game:"2-3, 1 2B, 1 RBI, 1 BB", points:"0.8", OP:"3", day:"4"},
    {id:"52", game:"3-4, 1 2B, 1 HR, 2 RBI", points:"1.1", OP:"4", day:"3"},
    {id:"76", game:"2-4, 1 2B, 1 HR, 2 RBI, 1 BB", points:"1.1", OP:"4", day:"9"},
    {id:"19", game:"1-4, 1 HR, 2 RBI, 1 BB, 1 SB", points:"0.9", OP:"3", day:"2"},
    {id:"16", game:"7 IP, 3 H, 1 ER, 1 BB, 10 K", points:"0.828571428571429", OP:"8", day:"9"},
    ...
    {id:"81", game:"3-4, 2 2B, 2 RBI", points:"1", OP:"4", day:"7"},
    ...
    {id:"92", game:"4.2 IP, 2 H, 1 ER, 3 BB, 5 K", points:"0.614285714285714", OP:"6", day:"6"},
    //acorns 
    {id:"78", game:"2-4, 1 HR, 4 RBI, 1 BB", points:"1.2", OP:"5", day:"9"},
    {id:"77", game:"2-5, 2 HR, 3 RBI", points:"1.1", OP:"4", day:"2"},
    {id:"65", game:"1-3, 1 HR, 2 RBI, 2 BB", points:"1", OP:"4", day:"7"},
    ...
    {id:"53", game:"1 IP, 0 H, 0 ER, 0 BB, 3 K", points:"0.9", OP:"9", day:"8"},
